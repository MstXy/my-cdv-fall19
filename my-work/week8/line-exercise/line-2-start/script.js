...
function gotData(incomingData){
  ...
  //     .attr("stroke", "black")
  //     .attr("stroke-width", 5)
  //     .attr("stroke", function(d,i) { return (d[0].country == "United States") ? "blue" : "red"})
  // ;
  function btnClicked() {

    let datagroups = graphGroup.selectAll(".line").data(data, function(d,i) {
      return d.year;
    });
    ...
    datagroups.enter()
      .append("path")
        ...
        .attr("class", "line")
    ;
    datagroups.transition().attr("d", lineMaker).attr("stroke", function(d,i) { return (d[0].country == "United States") ? "blue" : "red"});
