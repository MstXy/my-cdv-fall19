...
viz.append("rect")
    ...
    .attr("stroke", "#3d3d3d")
    .attr("stroke-width", 3)
    .attr("transform", "rotate(10) translate(1719, 459)")
;
viz.append("rect")
    .attr("width", 260)
    .attr("height", 10)
    ...
    .attr("stroke", "#3d3d3d")
    .attr("stroke-width", 3)
    .attr("transform", "rotate(-10) translate(1580, 319)")
;
viz.append("rect")
    .attr("width", 260)
    .attr("height", 10)
    ...
    .attr("stroke", "#3d3d3d")
    .attr("stroke-width", 3)
    .attr("transform", "rotate(170) translate(-648, -886)")
;
viz.append("rect")
    .attr("width", 260)
    .attr("height", 10)
    ...
    .attr("stroke", "#3d3d3d")
    .attr("stroke-width", 3)
    .attr("transform", "rotate(-170) translate(-785, 88)")
;
//GLOBAL ATTRIBUTES
x1 = 250;
x2 = 500;
